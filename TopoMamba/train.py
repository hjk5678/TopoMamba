...
def build_param_group_optimizer(
    ...
    **kwargs,
    ...
    if is_main:
        print("=" * 80)
        print("[Optimizer] TPDB parameter groups")
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            if is_main_process():
                print(
                    ...
                    f"LR_backbone: {lr_info.get('backbone', 0.0):.6e} | "
                    f"LR_new: {lr_info.get('new_modules', 0.0):.6e} | "
                    f"Time: {elapsed:.1f}s"
                )
